...
namespace DBH.BootstrapTheme
{
    ...
    /// 
    /// Because the control inherits from BootstrapThemeSettingsBase you have access to any custom properties
    ...
    public partial class Settings : ModuleSettingsBase
    {
        ...
        public override void UpdateSettings()
        {
            try
            {
                ...
                modules.UpdateModuleSetting(ModuleId, "Theme", optTheme.SelectedValue);

                //tab module settings
                modules.UpdateTabModuleSetting(TabModuleId, "Theme", optTheme.SelectedValue);
            }
            catch (Exception exc) //Module failed to load
            {
                Exceptions.ProcessModuleLoadException(this, exc);
